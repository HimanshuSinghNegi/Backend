...
//routes
router.get('/autoLogIn', ajvValidatorDto.ajvHeaderValidatorDto(tokenSchema), auth.autoLogIn);
router.get('/createAccessToken', ajvValidatorDto.ajvHeaderValidatorDto(tokenSchema), auth.createAccessToken);
